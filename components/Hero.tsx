...
export default function Hero() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="text-center text-white py-16 px-4 sm:py-20 sm:px-6 bg-gradient-to-b from-black via-black to-purple-900/20 mt-6 sm:mt-8 min-h-screen flex flex-col justify-center">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold mt-4 leading-tight sm:leading-snug">
          <span className="heading">Enterprise AI Agents</span>
          <br />
          <span className="text-2xl sm:text-5xl md:text-6xl lg:text-7xl">for the Future</span>
        </h1>

        <div className="mt-6 max-w-md mx-auto w-full px-4 sm:px-0">
          <InputField />
        </div>

        <div className="mt-4 lg:-mt-2 lg:-mb-8 flex flex-col sm:flex-row sm:gap-8 gap-4 justify-center items-center w-full">
          <button className="w-full sm:w-auto max-w-xs px-6 py-3 lg:py-5 bg-gradient-to-l from-purple-800 to-blue-600 hover:bg-gradient-to-l from-purple-800 to-blue-600 text-white font-bold rounded-lg text-lg transition-all duration-500 ease-in-out transform hover:scale-105 shadow-md hover:shadow-[0_0_20px_5px_rgba(147,51,234,0.5)] flex items-center gap-2">
            Deploy Your AI Agent <span className="text-xl">&gt;</span>
          </button>

          <button className="w-full sm:w-auto max-w-xs border border-purple-600 px-6 py-3 lg:py-5 rounded-md font-semibold text-white transition-all duration-300 ease-in-out shadow-md hover:shadow-[0_0_20px_5px_rgba(147,51,234,0.5)]">
            Watch Demo
          </button>
        </div>
      </section>
